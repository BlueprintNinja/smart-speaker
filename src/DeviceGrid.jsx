...
const DEFAULT_DEVICES = [
  { entity_id: "input_boolean.tuya_master_valve_1", name: "GIEX Valve 1 (Rows 1-4)", icon: "🌊", color: "#0ea5e9" },
  { entity_id: "input_boolean.tuya_master_valve_2", name: "GIEX Valve 2 (Rows 5-8)", icon: "🌊", color: "#0ea5e9" },
...
const STORAGE_KEY = "device_grid_v3";
const ICON_MAP = {
